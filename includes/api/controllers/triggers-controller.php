...
class TriggersController extends BaseController
{
    ...
    public function get_items($request)
    {
        ...
        // assets/json/integrations.json is generated by dev-tools/ and ships with
        // the plugin. Overlay its definitions onto the live set; the registry
        // stays the authority on the key set, so a stale manifest cannot drop an
        // integration that has since been activated.
