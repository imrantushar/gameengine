...
class TriggersController extends BaseController
{
    ...
    public function get_items($request)
    {
        ...
        // The registry is the only source of triggers: it returns the integrations
        // whose addon is active and whose host plugin is present, with the field
        // schema each one contributes at runtime. Nothing is read from a
        // build-time snapshot, which would go stale as soon as an extension
        // registered or withdrew a field.
