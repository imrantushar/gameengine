...
class Content_Filter
{
    ...
    public static function apply_restriction($content)
    {
        ...
        $type       = get_post_meta($post_id, '_gameengine_restrict_type', true);
        $required_v = get_post_meta($post_id, '_gameengine_restrict_value', true);
        $lock_msg   = get_post_meta($post_id, '_gameengine_restrict_message', true);
