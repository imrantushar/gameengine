    ...
    return <div className="flex justify-between items-center" style={{
      "padding": "24px 0"
                ...
                <div className="flex items-end gap-4">
                    <Select className="gameengine-select" classNamePrefix="gameengine-select" placeholder="All Points" options={pointTypes} isClearable onChange={opt => {
          dispatch(setFilterPointType(opt ? opt.value : null));
          dispatch(setPage(1));
        }} />

                    <Select className="gameengine-select" classNamePrefix="gameengine-select" defaultValue={timeRangeOptions[0]} options={timeRangeOptions} onChange={opt => {
