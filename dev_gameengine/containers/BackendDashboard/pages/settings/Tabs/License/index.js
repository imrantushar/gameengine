...
const License = () => {
  ...
  return <>
			<>
				{isActive ? <div className="flex flex-col items-center text-center bg-white rounded p-6 [box-shadow:var(--gameengine-shadow)]">
...
const MetaItem = ({
  ...
  valueColor
		...
		{typeof value === 'string' || typeof value === 'number' ? <p className="font-semibold m-0" style={{
    "fontSize": "13px",
