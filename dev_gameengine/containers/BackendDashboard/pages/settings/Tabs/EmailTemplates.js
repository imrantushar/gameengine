...
const EmailTemplates = ({ handleSubmit, isSubmitting, dirty }) => {
    ...
    return <div className="w-full overflow-visible">
        ...
        <GameEngineBox dynamicClasses='gameengine-settings mb-[30px]' boxShadow="var(--gameengine-shadow)" overflow="visible">
            <div className="flex items-center justify-between gap-4 border-0 border-b border-solid border-[var(--gameengine-border-color)] mb-6 pb-4">
                <p className="text-xl font-medium text-[var(--gameengine-font-color)] leading-[30px] m-0">
