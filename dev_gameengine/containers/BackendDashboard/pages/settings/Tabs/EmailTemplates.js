                                ...
                                <div className="flex items-center gap-5">
                                    <Dialog.Root size="cover" placement="center" motionPreset="slide-in-bottom" onOpenChange={(isOpen) => { if (isOpen) setEditingKey(key); }} maxW="1230px">
                                        <Dialog.Trigger asChild>
                                            <button className="flex gap-1.5 bg-transparent text-[var(--gameengine-font-color)] border border-solid border-[var(--gameengine-border-color)] px-4 py-[10px] rounded whitespace-nowrap cursor-pointer">
