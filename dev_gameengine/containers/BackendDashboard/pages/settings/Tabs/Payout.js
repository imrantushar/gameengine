...
const Payout = () => {
  ...
  return (
    <GameEngineBox dynamicClasses='gameengine-settings' boxShadow="var(--gameengine-shadow)" width="100%">
      ...
      <SettingsInput label={__("Enable Payout", "gameengine")}  margin='0 0 24px 0'>
        <Switch.Root
            colorPalette="blue"
            size="sm"
            mt="0.5"
      ...
      <SettingsInput label={__("Payout methods", "gameengine")}  margin='0 0 24px 0'>
        <Select
      ...
      <SettingsInput width='100%' label={__("Max Points", "gameengine")}  margin='0 0 24px 0'>
        <Input
          type="number"
          min="0"
          step="1"
      ...
      <SettingsInput width='100%' label={__("Min Points", "gameengine")} margin='0 0 24px 0'>
        <Input
          type="number"
          min="0"
          step="1"
