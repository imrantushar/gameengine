...
const infoCardsData = [{
  ...
  details: __('Reward learners with points, badges, and levels for course progress, quizzes, and engagement. boost!', 'gameengine'),
  required_plugin: [{
  ...
  is_pro: false,
  is_coming_soon: false,
  details: __('Reward learners with points, badges, and levels for course completions, lessons, and quizzes.', 'gameengine'),
  required_plugin: [{
  ...
  is_pro: false,
  is_coming_soon: false,
  details: __('Gamify purchases by rewarding customers for orders, spending, reviews, and store actions engagement', 'gameengine'),
  required_plugin: [{
  ...
  is_pro: false,
  is_coming_soon: false,
  details: __('Add points, achievements, and ranks to WooCommerce actions like buying, reviews, and refunds. perks!', 'gameengine'),
  required_plugin: [{
  ...
  is_pro: false,
  is_coming_soon: false,
  details: __('Unlock content, levels, or rewards only when users complete goals or achievements earned progress!!', 'gameengine'),
  ...
  is_pro: false,
  is_coming_soon: false,
  details: __('Control access by restricting posts, pages, or sections based on points, ranks, or badges. controlled', 'gameengine'),
  required_plugin: false,
  icon: false,
  ...
  is_pro: false,
  is_coming_soon: false,
  details: __('Visualize user progress with maps showing completed tasks, paths, milestones, and rewards. gamified!', 'gameengine'),
  required_plugin: false,
  icon: false,
  ...
  is_pro: true,
  is_coming_soon: false,
  details: __('Manage and view your wallet transactions with a clear list of balances, earnings, expenses, and payment history. Stay organized and in control!', 'gameengine'),
  required_plugin: false,
  icon: false,
  image: plugin_root_url + 'assets/images/progress_map.svg',
  docsUrl: 'https://quizpress.pro/docs/how-to-sell-quiz-with-woocommerce/',
...
const statusOptions = [{
  value: 'all',
  label: __('All Status', 'gameengine')
}, {
  value: 'active',
  label: __('Active', 'gameengine')
}, {
  value: 'inactive',
  label: __('Inactive', 'gameengine')
}
  ...
  return <>
        ...
        "padding": "16px 0"
            ...
            "color": "#718096"
						...
						<Select options={statusOptions} value={selectedStatus} onChange={selected => {
          ...
          ...addonsSavedData
            ...
            return <>
									{loading ? <AddOnsLoader /> : <div className="gameengine-dashboard-addon-cards flex w-full flex-wrap gap-4">
											{addonLists.length ? addonLists.map((item, index) => <AddonCard item={item} key={index} index={index} value={values[item.name]} setFieldValue={setFieldValue} />) : <CustomTableMessage title={__('No Addons Found!', 'academy')} />}
										</div>}
								</>;
          }}
					</Formik>
