    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center min-h-[200px] gap-3 py-10 text-center border border-dashed border-[var(--gameengine-border-color)] rounded">
                <div className='bg-[var(--gameengine-primary-light)] rounded-full w-[50px] h-[50px] flex items-center justify-center'>
                    <img
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-sm text-[var(--gameengine-warn-muted)] leading-5 m-0">
                        {__('Drag and drop an item from Available Hooks to activate it', 'gameengine')}
                    </p>
                </div>
            </div>

            <div className='flex items-start gap-2 bg-[var(--gameengine-secondary-color)] border border-solid border-[var(--gameengine-border-color)] border-l-2 border-l-[var(--gameengine-primary)] rounded mt-6 p-3'>
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[10px] text-[var(--gameengine-warn-muted)] leading-[14px] m-0">
