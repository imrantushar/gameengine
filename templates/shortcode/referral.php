...
<div class="ge-referral-container">
    ...
    <div class="ge-stats-grid">
        <div class="ge-stat-card">
            ...
            <div class="ge-stat-info">
                ...
                <span class="ge-stat-value"><?php echo number_format_i18n($total_clicks); ?></span>
            </div>
        </div>
        <div class="ge-stat-card">
            ...
            <div class="ge-stat-info">
                ...
                <span class="ge-stat-value"><?php echo number_format_i18n($total_referrals); ?></span>
            </div>
        </div>
        <div class="ge-stat-card">
            ...
            <div class="ge-stat-info">
                ...
                <span class="ge-stat-value"><?php echo number_format_i18n($total_points); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="ge-section ge-link-section">
        ...
        <div class="ge-share-grid">
            ...
            <a href="mailto:?subject=<?php echo rawurlencode(__('Join me on GameEngine!', 'gameengine')); ?>&body=<?php echo rawurlencode(sprintf(__('Check out this awesome platform: %s', 'gameengine'), $referral_url)); ?>" class="ge-share-btn email" title="Share via Email">
                            ...
                            <tr>
                                <td>
                                    <div class="ge-user-name">
                                        <div class="ge-avatar"><?php echo substr($ref->display_name, 0, 1); ?></div>
                                        <span><?php echo esc_html($obfuscate_name($ref->display_name)); ?></span>
                                    </div>
                                </td>
