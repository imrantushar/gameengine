...
const HelpModal = ({
	...
	<WPModal
		isOpen={isOpen}
		title={__('Help', 'academy')}
		suffix="help"
		onRequestClose={closeModal}
		contentLabel={__('Need Help?', 'academy')}
	...
	>
		...
		<Search
			placeholder={__('Search Docs', 'academy')}
		...
		{searchText.length === 0 ? (
			<>
				<DocList
					title={__('Related Docs', 'academy')}
					data={relatedData}
					notDocsFound={__('No Related docs available', 'academy')}
				/>

				<DocList
					title={__('Common Docs', 'academy')}
					data={commonData}
					notDocsFound={__('No Related docs available', 'academy')}
				/>
			</>
			...
			<DocList
				...
				data={searchedData}
				notDocsFound={__('No results found!', 'academy')}
			/>
		)}
	</WPModal>
);
